(function (a, b) {
  ...
  (function () {
    ...
    div.innerHTML =
      '<h3 class="dialog-title">&nbsp;</h3><a href="javascript:;" class="dialog-minmax" title="Minimize">&ndash;</a><a href="javascript:;" class="dialog-close" title="Close">&times;</a><div class="dialog-content">&nbsp;</div><div class="dialog-action"></div>';
  ...
  a.setDialog = function (set, config) {
    ...
    dialog_overlay.style.display =
      set == "open" && defaults.overlay ? "block" : "none";
